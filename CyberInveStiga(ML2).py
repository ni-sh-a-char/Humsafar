...
import pickle  # Import pickle to load the consolidated models

# Load the consolidated models from the Pickle file
with open("consolidated_models.pkl", "rb") as consolidated_file:
    models = pickle.load(consolidated_file)
...
if menu_option == "Packet Capture Analysis":
    ...
    # Intrusion detection logic should be added here using the loaded models and other processing.
...
if __name__ == "__main__":
    ...
    if page == "Home":
        st.sidebar.header("Packet Capture Analyzer and IDS")
    elif page == "About":
        st.sidebar.header("About")
        st.write("This is a Streamlit app for packet capture analysis and intrusion detection.")
